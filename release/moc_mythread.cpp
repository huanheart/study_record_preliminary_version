...
QT_MOC_LITERAL(1, 9, 10), // "ConveyJson"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9), // "Init_Json"
QT_MOC_LITERAL(4, 31, 4) // "json"

    },
    "MyThread\0ConveyJson\0\0Init_Json\0json"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ConveyJson((*reinterpret_cast< Init_Json(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MyThread::*_t)(Init_Json );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::ConveyJson)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::ConveyJson(Init_Json _t1)
{
